  ...
  return (
    ...
    <div className="flex flex-col lg:justify-center pt-28 lg:pt-0 items-center h-screen">
      <div className=" w-[400px] sm:w-[500px] md:w-[580px] lg:w-4/5 ">
        ...
        <p className="text-center sm:text-start lg:text-center lg:text-6xl md:text-5xl text-4xl font-semibold sm:mb-6 lg:mb-10 mb-4 ">&lt;Hello, I'm <span className=" text-pink-700 lg:text-6xl md:text-5xl text-4xl font-semibold  ">Akriti</span>!&gt;</p>
        <p className="lg:text-6xl md:text-5xl text-4xl  font-semibold sm:mb-6 lg:mb-10 mb-4 text-center sm:text-start lg:text-center ">&lt;<span className="   text-pink-800">Reactjs</span> Developer.&gt;</p>
